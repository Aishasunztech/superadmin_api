...
Source Database       : lm_superadmin

Target Server Type    : MYSQL
Target Server Version : 50505
File Encoding         : 65001

Date: 2019-06-18 10:19:15
*/
...
CREATE TABLE `admins` (
  ...
  CONSTRAINT `admins_ibfk_1` FOREIGN KEY (`type`) REFERENCES `user_roles` (`id`)
...
CREATE TABLE `chat_ids` (
  ...
  KEY `whitelabel_id` (`whitelabel_id`) USING BTREE
...
CREATE TABLE `devices` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fl_dvc_id` varchar(100) DEFAULT NULL,
  `wl_dvc_id` varchar(100) NOT NULL,
  `whitelabel_id` int(11) DEFAULT NULL,
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `unique_device_id` (`wl_dvc_id`) USING BTREE
...
CREATE TABLE `device_whitelabel` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `unique_device_whitelabel` (`device_id`,`whitelabel_id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;

-- ----------------------------
-- Records of device_whitelabel
-- ----------------------------
...
CREATE TABLE `dropdown_list` (
  ...
  CONSTRAINT `dropdown_list_ibfk_1` FOREIGN KEY (`dealer_id`) REFERENCES `admins` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of dropdown_list
-- ----------------------------
...
CREATE TABLE `paginations` (
  ...
  KEY `dealer_id` (`dealer_id`) USING BTREE,
  CONSTRAINT `paginations_ibfk_1` FOREIGN KEY (`dealer_id`) REFERENCES `admins` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of paginations
-- ----------------------------
...
CREATE TABLE `sim_ids` (
  ...
  KEY `whitelabel_id_index` (`whitelabel_id`) USING BTREE
...
CREATE TABLE `whitelabel_apks` (
  ...
  `apk_icon` text,
  `apk_file` text,
  `apk_size` varchar(100) DEFAULT NULL,
  `unique_name` text,
  `label` varchar(300) DEFAULT NULL,
  `version_name` text,
  `version_code` text,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `unique_whitelabel_id_package_name` (`whitelabel_id`,`package_name`,`label`) USING BTREE
...
CREATE TABLE `white_labels` (
  ...
  `api_port` varchar(255) DEFAULT NULL,
  `ip_address` varchar(255) DEFAULT NULL,
